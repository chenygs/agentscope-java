 ...
 */
@Entity
@Table(name = "ai_agent_session_state", indexes = {
        @Index(name = "idx_session_state", columnList = "session_id, state_key, item_index")
})
@IdClass(AiAgentSessionStateEntity.AgentSessionStateId.class)
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class AiAgentSessionStateEntity {
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    public static class AgentSessionStateId implements Serializable {
        private String sessionId;
        private String stateKey;
        private Integer itemIndex;
        ...
        public boolean equals(Object o) {
            ...
            if (!(o instanceof AgentSessionStateId that)) return false;
