...
public class AgentService {
    ...
    private final io.agentscope.builder.saton.agent.service.runtime.AgentRuntimeResolver runtimeResolver;
    private final io.agentscope.builder.saton.session.service.SessionService sessionService;
    ...
    public AgentService(AgentDefinitionRepository repo,
                        ...
                        io.agentscope.builder.saton.agent.service.runtime.AgentRuntimeResolver runtimeResolver,
                        io.agentscope.builder.saton.session.service.SessionService sessionService,
    ...
    private static String serializeToolSpecs(java.util.List<io.agentscope.builder.saton.agent.orm.entity.ToolSpec> specs) {
